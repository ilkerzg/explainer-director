...
8. **Object beats (mandatory pass)** — word-synced prop pop-ins over the concatenated video: noun literalization every 6-8s, pop-settle enable-window animation, X-outs, pop SFX beats. Grammar + measured densities in [references/directing.md](references/directing.md). A video with only 1-2 inserts and no pop-ins is UNDER-DIRECTED for the house style.
